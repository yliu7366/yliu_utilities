...
```
The table above shows that 7 *v100x* nodes and 84 individual *v100x* GPUs are available, for example. Each *v100x* node has 373GB system memory and 1.6TB disk space available. Check the [Biowulf hardware page](https://hpc.nih.gov/systems/hardware.html) for more details.
